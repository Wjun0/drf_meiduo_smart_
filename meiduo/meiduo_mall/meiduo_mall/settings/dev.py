...
# sys.path.insert(0, '/Users/smart/Desktop/sh24_code/meiduo_sh24/meiduo_mall/meiduo_mall/apps')
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://172.16.179.179:6379/0",
        "OPTIONS": {
    ...
    "session": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://172.16.179.179:6379/1",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    ...
    "histories": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://172.16.179.179:6379/4",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
